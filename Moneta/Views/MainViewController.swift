...
class MainViewController: UIViewController, TransactionDetailViewDelegate, NewTransactionDelegate {
    ...
    private func setupUI() {
        ...
        adjustTableHeaderViewSize()
        updateLabels()
        addPlaceholderViewIfNoTransaction()
    }
    ...
    private func addConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            view.safeAreaLayoutGuide.bottomAnchor.constraint(equalTo: addTransactionButton.bottomAnchor, constant: 76)
        ])
    }
    
    private func addPlaceholderViewIfNoTransaction() {
    ...
    func showToastWhenDeletedTransaction() {
...
extension MainViewController {
    ...
    func didDeletedTransaction() {
        updatePlaceholderViewVisibility()
        showToastWhenDeletedTransaction()
    }
}
